...
.get({
    ...
    .get({
        ...
        var session = {"controller":"cache","action":"get","params":{"names":oasisArr},"session":"d775c11f8c23ef780be0"};
        ...
        request
            .post({
                ...
                url: 'http://ks2-ru.travian.com/api/?c=cache&a=get&t1451686086748',
